...
export default function Pagination({ totalPages = 10 }) {
  ...
  return (
    <nav
      className="flex items-center justify-center space-x-1 my-8"
    ...
    >
      ...
      <div className="hidden sm:flex space-x-1">
        {pages.map((numero) => (
          <button
            ...
            aria-current={currentPage === numero ? "page" : undefined}
      ...
      {/* Indicador Móvil (Opcional para pantallas pequeñas) */}
      <span className="flex sm:hidden text-sm text-gray-700 px-4">
